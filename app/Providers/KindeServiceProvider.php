...
class KindeServiceProvider extends ServiceProvider
{
     ...
     * 1. Registers the custom 'kinde' auth guard driver
    ...
    {
        // Register the custom Kinde guard driver
        Auth::extend('kinde', fn ($app, $name, $config) => new KindeGuard($app->make(KindeService::class)));
